...
public class RongyingbaoPojectBean implements Serializable  {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public List<RongyingbaoPojectData> data;
	public String errorCode;
	public String message;
	public class RongyingbaoPojectData implements Serializable{
		/**
		 * 
		 */
		private static final long serialVersionUID = 1L;
